...
natureAnswers.forEach((natureAnswerInput, index) => {
  natureAnswerInput.addEventListener("keyup", () => {
    let answer = natureAnswerInput.value;
    debugger;
    if (answer == nature[index].answer) {
